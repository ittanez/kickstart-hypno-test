// Catégories et descriptions dérivées du score, côté serveur.
// Miroir de src/utils/calculateScore.ts : le contenu de l'email ne doit
// jamais provenir du client (anti-injection HTML / anti-phishing).
...
export const getResultForScore = (score: number): ScoreResult => {
  if (score <= 30) {
    return {
